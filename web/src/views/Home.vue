      ...
      <!--end of swiper-->
        ...
        <m-list-card icon="menu" title="新闻资讯" :categories="newsData">
           <template #items="{category}">
              ...
              class="newsitem pt-1 pl-1 d-flex" v-for="(news,index) in category.newsList" :key="index">
        ...
        <m-list-card icon="yingxiong" title="英雄列表" :categories="heroData">
            <template #items="{category}">
              <div class="d-flex flex-wrap" style="margin: 0 -0.5rem">
                ...
                tag="div"
                :to="`/heroes/${hero._id}`"
                 class="p-2 text-center" style="width: 20%;" v-for="(hero,index) in category.heroList" :key="index">
